...
let cansLeft = 15; // Any number of cans
let result = (cansLeft < 5) ? "Time to restock!" : "We're stocked!";
console.log(result);
...
let temperature = (currentTemp <= 5) ? "Chilled to perefction!" : "Needs a cooler!" ;
...
let currentHour = 22;
let hour = (currentHour >= 7 && currentHour < 24) ? "Unleash the beast!" : "Better stick to water." ;
console.log(hour);
